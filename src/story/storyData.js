...
// Story presentation scaffold for audio/VFX/background integration.
// These are data-only tags; consumers can opt in incrementally.
export const STORY_PRESENTATION_PRESETS = {
  backgroundKeys: {
    wardensPass: 'brave_wardens_pass',
    ashbridgeToll: 'brave_ashbridge_toll',
    unbrokenPhalanx: 'brave_unbroken_phalanx',
    warcamp: 'brave_warcamp',
    watchtower: 'brave_watchtower',
    ironRegentChamber: 'brave_iron_regent_chamber',
    dawnfallBridge: 'brave_dawnfall_bridge',
    halbrechtFortressCourtyard: 'brave_halbrecht_fortress_courtyard',
    vaultOfEchoes: 'brave_vault_of_echoes',
    lightningRoad: 'brave_lightning_road',
    throneRoomFracture: 'brave_throne_room_fracture'
  },
  ambientKeys: {
    windAsh: 'amb_brave_wind_ash',
    bridgeFire: 'amb_brave_bridge_fire',
    warcampDrums: 'amb_brave_warcamp_drums',
    towerHum: 'amb_brave_watchtower_hum',
    relicPulse: 'amb_brave_relic_pulse',
    fortressSiege: 'amb_brave_fortress_siege',
    stormPass: 'amb_brave_storm_pass',
    vaultInstability: 'amb_brave_vault_instability',
    throneInstability: 'amb_brave_throne_instability'
  },
  stingerKeys: {
    confrontation: 'stinger_confrontation',
    relicReveal: 'stinger_relic_reveal',
    betrayal: 'stinger_betrayal',
    collapse: 'stinger_collapse',
    gateBreach: 'stinger_gate_breach',
    finalStrike: 'stinger_final_strike'
  },
  vfxTags: {
    fogIllusion: 'vfx_fog_illusion',
    relicLightning: 'vfx_relic_lightning',
    spectralChains: 'vfx_spectral_chains',
    vaultPulse: 'vfx_vault_pulse',
    ashDebris: 'vfx_ash_debris'
  }
};
...
export const STORY_ARCS = {
  brave: {
    id: 'brave',
    name: 'Brave Kingdom',
    bannerHeroes: ['lancerID', 'warriorID'],
    bannerPositions: [7, 6],
    prologue: [
      ...
      'As Warrior and Lancer prepared their warband for the journey, they knew the stakes extended beyond mere survival. The mercenary lords watched from their fortified manors, their agents embedded in every court and tavern. Deserted soldiers roamed the borderlands, their loyalties for sale to the highest bidder. And in Brimstone Valley itself, the ash stirred with unnatural life, as if the relics called to those who sought them.',
      'The Contract Age had transformed warriors into merchants and honor into a commodity. But deep in the valley\'s heart, where the Heart of Brimstone pulsed with forbidden power, the old ways might yet find resurrection. Warrior and Lancer marched not just for a relic, but for the soul of a kingdom that refused to die quietly. Their journey would test not only their steel, but the very foundations of the world they sought to save.'
    ],
    intro: [
      'Steel once solved every crisis for the Brave Kingdom. Now the forges are cold and the vaults thin.',
      'The Crown sends a mercenary band under Lancer and Warrior to retrieve a relic rumored to awaken dormant armories.',
      ...
      nodes: [
        {
          id: 'caravan_clash',
          type: 'battle',
          title: 'Chapter I: The Caravan Clash',
          description: 'Mercenary Lord Varric seizes a relic caravan and dares the Crown to take it back.',
          chapter: 1,
          presentation: {
            backgroundKey: 'brave_wardens_pass',
            ambientKey: 'amb_brave_wind_ash',
            stingers: { intro: 'stinger_confrontation', victory: 'stinger_betrayal' },
          ...
          dialogue: [
            ...
            { speaker: 'Warrior', side: 'right', text: 'Then let\'s settle it cleanly. Steel first. Politics after.' }
          ],
          battleDialogue: [
            {
              speaker: 'Varric',
              ...
              text: 'You came fast. Good. Tell your queen these crates are collateral. The Crown owes more than coin can repay.'
            },
            {
              speaker: 'Lancer',
              side: 'left',
              ...
              text: 'Debts are argued in courts, not carved from convoy guards. Stand down and we walk away with the relics.'
            },
            {
              speaker: 'Varric',
              side: 'right',
              ...
              text: 'Courts? The old courts are bankrupt and afraid. Out here, ownership is measured by who can hold the line.'
            },
            {
              speaker: 'Warrior',
              side: 'left',
              ...
              text: 'Then hold it, Varric. We\'ll test your claim blade to blade.'
            }
          ],
          enemyTeam: 'brave_caravan_clash',
          next: ['chapter1_complete']
        },
        {
        ...
        },
        {
          ...
          dialogue: [
            ...
            { speaker: 'Warrior', side: 'left', text: 'We could offer them a better contract. The Crown still has some gold left—enough to buy their passage.' },
            ...
            { speaker: 'Warrior', side: 'left', text: 'But fighting them all would be suicide. There must be a hundred blades here, all hungry for relic wealth.' },
            { speaker: 'Lancer', side: 'right', text: 'Then we make our stand. Let this camp remember that some things still can\'t be purchased.' },
            { speaker: 'Warrior', side: 'left', text: 'The battle mage leading them... his magic could tear us apart before we close. But we\'ve faced worse odds.' },
        ...
        },
        {
          ...
          presentation: {
            ...
            stingers: { intro: 'stinger_relic_reveal', victory: 'stinger_relic_reveal' },
            vfxTags: ['vfx_fog_illusion', 'vfx_vault_pulse'],
            musicIntensity: 'medium'
          },
          preBattle: [
          ...
          dialogue: [
            ...
            { speaker: 'Warrior', side: 'left', text: 'His magic could unravel us before we reach the door. But we\'ve faced sorcerers before—illusions break when met with steel.' },
            ...
            { speaker: 'Warrior', side: 'left', text: 'Reason with a man who lives in isolation, bound to a glowing rock? He\'s beyond reason. But we\'ll try words before blades.' },
            ...
            { speaker: 'Warrior', side: 'left', text: 'Agreed. Forward—we claim what\'s ours, for the people who still believe in the kingdom\'s future.' }
          ],
          battleDialogue: [
            {
              speaker: 'Arcane Mage',
        ...
        },
        {
          ...
          description: 'A Warrior in stolen relic-plate guards the Heart of Brimstone.',
          presentation: {
            backgroundKey: 'brave_iron_regent_chamber',
            ambientKey: 'amb_brave_relic_pulse',
            stingers: { intro: 'stinger_relic_reveal', victory: 'stinger_final_strike' },
            vfxTags: ['vfx_relic_lightning', 'vfx_vault_pulse', 'vfx_ash_debris'],
            musicIntensity: 'high'
          },
          preBattle: [
          ...
          dialogue: [
            ...
            { speaker: 'Lancer', side: 'right', text: 'Look at him—he was a Warrior once, like you. The relic corrupted him, turned him into this... thing. We must not let it do the same to us.' },
            { speaker: 'Warrior', side: 'left', text: 'We won\'t. Our oaths are stronger than any relic\'s pull. Forward—we end this and begin the restoration.' }
          ],
          battleDialogue: [
            {
              speaker: 'Iron Regent',
            ...
            },
            {
              ...
              text: 'The era ends when we let it. You were a Warrior once, sworn to protect the realm. The relic corrupted you, but it doesn\'t have to corrupt us. Step aside.'
            },
            {
              speaker: 'Iron Regent',
              side: 'right',
...
Lancer had served the royal army since he was a boy, trained in the old ways of honor and loyalty. He believed in the kingdom even as it crumbled around him. Warrior, his closest friend, had a different view. Warrior had seen the corruption in the royal court, the incompetence of nobles who clung to tradition while the world burned. To him, the mercenary lords represented a new order—harsh, but honest.
...
And so the kingdom teetered between two futures: one clinging to the old ideals, the other embracing the ruthless pragmatism of the new age. Lancer and Warrior, unaware of how deeply they were already entangled in this struggle, were summoned to the palace for a mission that would test their loyalty—and their friendship.
...
Warrior: “And we escaped because we weren’t weighed down by dead men’s ideals. If we had hired mercenaries—”
...
Warrior: “Then pay them. Or let them lead. The old ways are gone, Your Majesty.”
The queen’s eyes narrowed. The prince watched Warrior with interest. Lancer felt the room shift around him, as if invisible lines were being drawn.
...
Warrior: “Someone had to. The queen clings to a kingdom that no longer exists.”
Lancer: “And you think the mercenary lords will build something better?”
Warrior: “They already have. Order through strength. Payment for service. No lies about honor.”
Lancer hesitated, lowering his blade.
Lancer: “Honor isn’t a lie.”
Warrior: “Maybe not. But it’s a luxury we can’t afford.”
A horn sounded from the palace walls. A messenger sprinted toward them.
Messenger: “Lancer! Warrior! The queen commands your presence. A mercenary lord has seized one of our relic caravans. She wants you to take it back.”
Warrior smirked.
Warrior: “And so it begins.”
...
Warrior wanted to hear Varric’s offer.
Lancer wanted to uphold the kingdom’s honor.
Only one of them would get what they wanted.

Battle: “The Caravan Clash”
The battlefield is a narrow canyon road. Varric’s forces hold the high ground, guarding the stolen relic crates. Lancer and Warrior lead a small strike team of warriors, shield maidens, and a tinkerer who rigs explosive traps.
...
Warrior (arriving): “And I fight for the future.”
The three clash in a brutal exchange. Varric is forced to retreat, but not before planting a seed of doubt in Warrior’s mind—and a warning in Lancer’s.
...
Lancer and Warrior returned to the city as uneasy heroes. The people cheered them, but the cheers were hollow—born of desperation, not pride. The two men sensed the shift. The kingdom they had once served was becoming something else, something brittle and uncertain. Lancer clung to the belief that honor could still guide them. Warrior saw only the cracks widening.
...
The Brave Kingdom needed relics to survive. But every expedition risked provoking a war they could not win. And so the queen devised a plan: send a small, elite team to negotiate with a neutral mercenary lord—Lord Halbrecht, a former Warrior known for his strict code. If he could be convinced to side with the crown, others might follow.
Lancer was chosen for his loyalty. Warrior was chosen for his pragmatism. Together, they would travel to Halbrecht’s fortress and secure an alliance… or die trying.
...
Warrior: “And what am I? Decoration?”
...
Warrior smirked, though his eyes narrowed.
...
Warrior: “You trust her too much.”
Lancer: “She’s the queen.”
Warrior: “She’s desperate. Desperate rulers make dangerous decisions.”
Lancer tightened his grip on the reins.
Lancer: “And what of you? You speak as if you’ve already chosen a side.”
Warrior: “I’ve chosen survival. The crown can’t protect us anymore. Halbrecht, Varric, the mercenary lords—they’re the ones shaping the future.”
Lancer: “A future built on coin and blood.”
Warrior: “Better than a past built on lies.”
The wind howled across the plains. Neither spoke for a long time.

Battle Setup
When Lancer and Warrior arrive at Halbrecht’s fortress, they find it under siege.
...
Warrior sees an opportunity to negotiate with Halbrecht from a position of strength.
...
Lancer rallies Halbrecht’s defenders, forming a disciplined shield line to halt the berserkers’ advance. Warrior leads a flanking maneuver, cutting through the archers and seizing control of the battlements.
At the height of the battle, Garruk the Red smashes through the shield line, roaring for Halbrecht’s surrender. Lancer intercepts him, their weapons clashing in a storm of sparks. Warrior arrives moments later, striking from behind to weaken the brute.
...
Lancer and Warrior exchange a look.
...
But Halbrecht was no longer a Warrior of the crown. He had abandoned the kingdom years ago, disgusted by the corruption he witnessed in the royal court. His fortress stood as a symbol of what the Brave Kingdom had lost: honor without politics, strength without ambition. And now, with Varric’s influence spreading, Halbrecht found himself cornered between two futures he did not trust.
Lancer spoke passionately of unity, of restoring the kingdom’s dignity, of resisting the mercenary lords who sought to carve the land into fiefdoms. Halbrecht listened, his expression unreadable. Warrior, however, offered a different vision—one where the Brave Kingdom adapted rather than clung to dying traditions. He argued that relics, not royal decrees, now shaped power. Halbrecht respected the blunt truth in Warrior’s words.
The two arguments mirrored the fracture growing within the Brave Kingdom itself. Queen Aralyn had sent Lancer to secure Halbrecht’s loyalty. Prince Rowan had quietly encouraged Warrior to “keep an open mind.” And Halbrecht, caught between these competing visions, demanded time to consider his choice.
As the fortress was repaired, Halbrecht invited Lancer and Warrior to stay as his guests. But the hospitality was thin. Halbrecht’s lieutenants watched them closely. Rumors spread that Varric was preparing a second assault—this time with support from the Outcast Kingdom’s rogues and assassins. Halbrecht’s neutrality was no longer sustainable.
...
Halbrecht stood before the great hearth, staring into the flames as Lancer and Warrior waited.
...
Warrior: “The cost is inevitable. Better to choose who collects it.”
...
Warrior’s voice cut through the hall.
Warrior: “Or we adapt. Together.”
Halbrecht exhaled slowly.
Halbrecht: “I will give you my answer at dawn.”

Scene 2 — The Ramparts at Midnight
Warrior leaned against the stone wall, staring out at the dark plains. Lancer approached quietly.
Lancer: “You spoke well today.”
Warrior: “I spoke honestly.”
Lancer: “You spoke like someone who’s already chosen the mercenary lords.”
Warrior didn’t look away from the horizon.
Warrior: “Maybe I have. Maybe I’m tired of serving a kingdom that won’t save itself.”
Lancer: “The queen is trying.”
Warrior: “The queen is drowning. And she’ll drag us down with her.”
Lancer’s jaw tightened.
Lancer: “If you betray the kingdom—”
Warrior finally turned, eyes cold.
Warrior: “I’m not betraying anything. I’m surviving.”

Scene 3 — Halbrecht’s Decision
Dawn broke over the fortress. Halbrecht stood before his assembled soldiers, Lancer, and Warrior.
...
Warrior’s expression darkened.
Warrior: “The prince will never agree to that.”
Halbrecht: “Then the kingdom will fall.”
Lancer stepped forward.
Lancer: “I will deliver your terms.”
Warrior said nothing.
But his silence was louder than any protest.

Battle Setup
Before Lancer and Warrior can depart, Halbrecht’s scouts return with dire news:
...
Warrior hesitates—caught between loyalty to Halbrecht and the growing pull of Varric’s vision.
...
Warrior stands at the crossroads—literally and figuratively—watching Varric’s banner rise through the smoke.
When the blood golem breaches the inner gate, Warrior finally moves.
...
Lancer sees Warrior’s heroism.
He also sees Varric’s forces withdraw the moment Warrior intervenes.
...
The journey back to the Brave Kingdom was colder than the wind that swept across the plains. Lancer rode ahead, carrying Halbrecht’s terms like a sacred burden. Warrior followed several paces behind, silent, unreadable. The battle had changed something in him. Lancer had seen it in the way Warrior fought—not for the kingdom, not for Halbrecht, but for something else. Something unspoken.
...
Inside the palace, the tension was palpable. Queen Aralyn greeted Lancer with relief, but her eyes hardened when she saw Warrior. Rumors had reached her—rumors that Warrior had spoken with Varric’s envoys, that he had hesitated during the siege, that he had fought with a ferocity that seemed… opportunistic.
...
Lancer: “My king… the kingdom is fracturing. The prince defies the queen. Warrior… Warrior is slipping away from me.”
...
Scene 3 — Warrior and Rowan in the Shadows
Warrior found Rowan in a secluded corridor, speaking quietly with a hooded figure. When the figure left, Rowan turned to him.
Rowan: “You hesitated during the siege. Why?”
Warrior: “I was weighing my options.”
Rowan: “Good. You’re not blinded by loyalty like Lancer. I need someone like you.”
Warrior crossed his arms.
Warrior: “What are you planning?”
...
Warrior’s jaw tightened.
Warrior: “Obstacles like the queen.”
...
Warrior is ordered to lead the strike force.
He accepts.
...
Then Warrior emerges from the mist.
Warrior: “Lancer… stand aside.”
Lancer: “You’re with Rowan.”
Warrior: “I’m with the future.”
The battle erupts.
...
- Lancer duels Warrior in a brutal, emotional clash
...
Warrior returned to the capital under Rowan’s orders. The prince praised him for “minimizing casualties,” but Warrior felt no pride. The ambush had crossed a line he never intended to cross. He had not struck the queen, but he had stood among those who tried. And Lancer’s expression — that mixture of pain and disbelief — haunted him more than any wound.
...
Meanwhile, the queen reached Halbrecht’s fortress. The old Warrior received her with solemn respect. When she knelt and swore the Oath of Reform — promising to purge corruption, restore the army, and rebuild the kingdom — Halbrecht accepted. His disciplined forces now stood with the crown. But he warned her that Rowan’s ambitions would not end with an ambush.
Lancer, recovering from his injuries, trained alongside Halbrecht’s soldiers. He felt a renewed sense of purpose. The queen’s oath had rekindled his faith in the kingdom. But he could not shake the memory of Warrior’s blade clashing against his own. The two had fought side by side for years. Now they stood on opposite sides of a war neither had wanted.
Warrior, for his part, found himself increasingly isolated. Rowan trusted him — but only as a tool. Varric’s envoys watched him with predatory interest. The palace guards loyal to Rowan treated him with wary respect. And the people whispered that he had betrayed the queen. Warrior began to realize that in choosing “the future,” he had stepped into a world where loyalty was currency and trust was a liability.
...
Scene 2 — Warrior and Rowan in the War Room
...
Rowan: “Speak, Warrior. You’ve fought beside Halbrecht’s men. What will they do?”
Warrior: “They’ll fight to the last. They believe in something.”
Rowan scoffed.
Rowan: “Belief is a luxury. Relics are power. And I intend to control every relic in the kingdom.”
Warrior’s eyes narrowed.
Warrior: “You’re planning to seize the Relic Vault.”
Rowan smiled.
Rowan: “You’re quick. Yes. And you will lead the operation.”
Warrior stiffened.
Warrior: “The vault is sacred. Even the king never—”
Rowan: “The king is stone. I am the future.”
Warrior felt the last remnants of loyalty crumble.

Scene 3 — Lancer and Warrior, a Meeting in Secret
Warrior slipped into the abandoned stables behind the palace. Lancer was already there, cloaked and hooded.
They stared at each other — two men who had once been brothers in arms.
Lancer: “Why did you come?”
Warrior: “To warn you. Rowan is going after the Relic Vault.”
Lancer’s eyes widened.
Lancer: “Why tell me?”
Warrior hesitated.
Warrior: “Because… I don’t know what side I’m on anymore.”
Lancer stepped closer.
Lancer: “Then choose. Now.”
Warrior looked away.
Warrior: “I can’t. Not yet.”
Lancer’s voice hardened.
Lancer: “Then stay out of my way.”
Warrior didn’t stop him as he left.
...
Warrior is caught between them.
...
Warrior steps out of the shadows.
Warrior: “Lancer… stop. If you take the core, the vault collapses.”
...
The Tethered Spirit lashes out, striking Warrior and sending him crashing into the relic core.
The core fractures.
Energy erupts.
The vault begins to collapse.
Lancer grabs Warrior, dragging him toward the exit.
Warrior, barely conscious, whispers:
Warrior: “I… choose… you.”
...
At Halbrecht’s fortress, the queen received word of the vault’s collapse. She was shaken, but not deterred. With Halbrecht’s disciplined forces and the loyalty of the remaining royalists, she began preparing for a march on the capital. Lancer, still recovering from the battle, trained relentlessly. He knew Rowan would retaliate. He also knew Warrior had saved his life — and that the choice Warrior made in the vault would haunt them both.
Warrior, meanwhile, found himself in a precarious position. Rowan praised him publicly for “defending the kingdom’s relics,” but privately, the prince was furious. Warrior had failed to secure the vault. Worse, he had returned without relics, without prisoners, and without a victory. Rowan’s trust began to erode. Varric’s envoys whispered that Warrior was unreliable. The palace guards loyal to Rowan watched him with suspicion.
...
Scene 3 — Warrior Alone in the Palace Armory
Warrior sat on a bench, staring at his gauntlets. The armory was silent, save for the distant hum of unstable relic energy.
A palace guard entered.
Guard: “The prince wants you. Now.”
Warrior didn’t move.
Warrior: “Tell him I’ll come when I’m ready.”
The guard hesitated.
Guard: “He said… if you refuse again, he’ll strip you of command.”
Warrior finally stood.
Warrior: “Let him try.”
...
Warrior is ordered by Rowan to lead the attack.
The two men are once again forced into conflict — but this time, Warrior is no longer uncertain.
He is angry.
Conflicted.
And dangerous.
...
Warrior emerges through the smoke, leading the charge.
Warrior: “Lancer! Stand down!”
...
Warrior: “I’m protecting what’s left of us.”
But the lightning mage unleashes a massive bolt that strikes the cliffside, triggering a landslide.
Warrior grabs Lancer and pulls him clear — but the caravan is crushed.
...
Warrior watched all of this unfold with growing unease. He had once believed Rowan represented the future — a harsh but necessary evolution. But now he saw the truth: Rowan was not building a new kingdom. He was seizing a throne. And Varric was using him as a stepping stone to Brimstone Valley. Warrior found himself trapped between two ambitions, neither of which aligned with the ideals he once fought for.
...
Character Scenes (3 scenes)
Scene 1 — Rowan and Warrior in the Throne Room
...
Warrior stood at the foot of the throne.
Warrior: “You forced your own hand when you allied with Varric.”
Rowan: “Varric is a means to an end.”
Warrior: “And when he demands Brimstone Valley?”
Rowan smiled thinly.
Rowan: “Then I will give it to him. Once I am king, I will take it back.”
Warrior’s jaw tightened.
Warrior: “You’re playing with fire.”
Rowan: “No. I’m forging a new kingdom.”
Warrior looked at the petrified king.
Warrior: “At what cost?”
...
Lancer hesitated.
Lancer: “Warrior is inside the walls.”
...
Warrior is ordered to lead the defense of the eastern gate — the gate Lancer is assigned to breach.
...
- Warrior commands the defenders with ruthless precision
Lancer reaches the gate.
Warrior stands atop the battlements, sword raised.
Their eyes meet.
The storm rages around them.
Warrior: “Turn back!”
Lancer: “Not while you stand with him!”
Warrior leaps from the wall, landing in front of the gate.
The two clash in a duel that shakes the stones beneath them.
Lightning crackles.
Steel screams.
The gate buckles.
The queen’s forces surge forward.
Warrior is driven back.
...
And at the center of it all stood Warrior and Lancer — two men who had once fought side by side, now forced to decide the fate of the kingdom they both loved.
...
Warrior: “I’m not commanding you. I’m begging you.”
Rowan’s eyes burned with ambition.
Rowan: “You’ve grown weak. Lancer has infected you with his ideals.”
Warrior’s voice cracked.
Warrior: “No. You’ve lost yours.”
Rowan raised the shard.
Warrior drew his sword.
...
Scene 3 — Warrior and Lancer, One Last Time
Lancer entered the throne room first.
Warrior stood between him and Rowan.
Their eyes met.
No hatred.
Only sorrow.
Lancer: “Step aside.”
...
It began to crack.
The palace shook.
Lancer lunged forward, grabbing Warrior as the relic exploded in a burst of unstable energy.
...
The queen, Halbrecht, Lancer, and Warrior must fight together — or die.
...
- Warrior and Lancer fight side by side once more
...
Warrior and Lancer strike together.
...
Warrior kneels before the queen, offering his sword.
Queen Aralyn: “Rise, Warrior. Your path was twisted, but your heart remained true.”
He rises.
